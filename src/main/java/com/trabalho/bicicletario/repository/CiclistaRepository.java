...
public interface CiclistaRepository extends CrudRepository<Ciclista, Integer> {
    ...
    void changeCiclistaId(int id, String nome, LocalDate data_nascimento, String cpf, String nacionalidade, int id_passaporte, int id_cartao, String email, String status, String url_foto_documento, String senha);
}